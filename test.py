...
def draw_difficulty_buttons():
    save_button = pygame.Rect(50, 50, 100, 50)
    ...
    return easy_button, medium_button, hard_button, debug_button, replay_button, save_button

# Fonction pour gérer les clics sur les boutons de difficulté
def handle_difficulty_buttons(tableau, tableau_resolve):
    global game
    easy_button, medium_button, hard_button, debug_button,replay_button, save_button = draw_difficulty_buttons()
    ...
    if pygame.mouse.get_pressed()[0]:
        if easy_button.collidepoint(mouse_x, mouse_y):
            ...
            print("replay panel") 
                ...
                carte_str = savemap(tableau, tableau_resolve)
                print(carte_str)
...
def savemap(tableau, tableau_resolve):
    result = ""
...
while running:
    ...
    handle_difficulty_buttons(game.tableau, game.tableau_resolve)
